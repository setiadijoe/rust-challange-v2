...
//!
//! ![Pumpikn](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
// To generate private documentation use `cargo doc --no-deps --document-private-items --open
